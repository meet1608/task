...
const InputForm = ({ onSubmit, isLoading }) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="w-full h-[calc(60vh-4.5rem)] p-6">
      ...
      <div className="mt-24 flex justify-end">
        <button
          type="submit"
          className="w-full md:w-auto flex items-center justify-center p-2 bg-blue-500 text-white rounded-md"
          disabled={isLoading}
        >
          {isLoading ? (
            <>
